...
public class MyFormAuthenticationFilter extends AuthenticatingFilter {
    ...
    public boolean isAxiosLoginRequest(ServletRequest request) {
        if (null == ((HttpServletRequest)request).getHeader("is-login"))
            return false;

        String header = ((HttpServletRequest) request).getHeader("is-login");
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        if (isAxiosLoginRequest(request)) {
